...
import { Home, ArrowLeft, Search, Building, Calendar, BookOpen } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Oops! It looks like this page is still being built. Our team is working hard to bring you amazing features. 
              In the meantime, explore what we already have to offer!
            </p>
          </motion.div>
